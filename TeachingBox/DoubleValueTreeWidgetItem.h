#ifndef _TEACHING_BOX_DOUBLE_VALUE_TREE_WIDGET_ITEM_H_
#define _TEACHING_BOX_DOUBLE_VALUE_TREE_WIDGET_ITEM_H_

/*************************************************
//  Copyright (C), 2015-2016, CS&S. Co., Ltd.
//  File name: 	    DoubleValueTreeWidgetItem.h
//  Author:			刘巍      
//  Version: 		1.0     
//  Date: 			2016/11/29
//  Description:    提供浮点型树形控件相关操作，包括生成控件，从控件中获取变量，继承自VariateValueTreeWidgetItem
//  Others:         
//  Function List:  
//  History:
//    <author>      刘巍 
...
class DoubleValueTreeWidgetItem:public VariateValueTreeWidgetItem
{
public:
...
private:
	static VariateValueTreeWidgetBuilder<DoubleValueTreeWidgetItem> buidler;
};
