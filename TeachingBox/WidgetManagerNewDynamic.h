#ifndef _TEACHING_BOX_VARIATE_WIDGET_WIDGET_MANAGER_NEW_DYNAMIC_H_
#define _TEACHING_BOX_VARIATE_WIDGET_WIDGET_MANAGER_NEW_DYNAMIC_H_

/*************************************************
//  Copyright (C), 2015-2016, CS&S. Co., Ltd.
//  File name: 	    WidgetManagerNewDynamic.h
//  Author:			刘巍      
//  Version: 		1.0     
//  Date: 			2016/11/15
//  Description:	用于生成新建Dynamic变量控件，并从该控件中获取变量值
...
{
	class WidgetManagerNewDynamic:public WidgetManagerNewVariate
	{
	public:
